...
public class Superman {
	...
	//생성자를 하나라도 구성하면 컴파일러가 제공하던 디폴트 생성자는 제공되지 않는다.	
	public Superman() {
		this("슈퍼맨",150,50); //자기자신의 생성자를 호출
//		name="슈퍼맨";
//		height=150;
//		power=50;
	}
...
//		power=150;
	...
	public Superman(String name, int height) {
		this(name, height, 200); //this()는 생성자의 첫번째 라인에서 호출해야 함
...
//		power=200;
	...
	public String showInfo() {
		//this("아무개",177,100);[x] 생성자 안에서 호출 가능
		String str="----슈퍼맨 정보----\n";
			str+="이름: "+name+"\n키 : "+height+"\n초능력: "+power;
			return str;
	}//showInfo()
